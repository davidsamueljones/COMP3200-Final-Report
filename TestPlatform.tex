...
\begin{itemize}
	...
	\item {\textbf{\texttt{TD\_CMD}}} : Command to trigger execution of a test definition (\ac{td}). A \ac{td} holds a \ac{lora} configuration (values for \ac{cf}, \ac{sf}, \ac{tp}, \ac{bw}, \ac{cr}, \ac{pl}), a required \ac{pc}, and \ac{ps}. Figure \ref{fig:software_testdef_execution} explains full control flow in detail.
	\end{itemize}
