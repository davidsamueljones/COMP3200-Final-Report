...
\begin{figure}[H]
    ...
    \caption[Box-plots of protocol data delivery percentage]{
    	Box-plots of DP in each environment [[A, B], [C, D]]. Highlighted is the consistency of ALOHA and \ac{csma} between environments. \ac{llbp}'s failings to select the correct \ac{dr} are highlighted by it only having acceptable performance in Environment A when any \ac{dr} will do.
